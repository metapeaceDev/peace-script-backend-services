...
class Settings(BaseSettings):
    ...
    # Database
    # Primary names
    MONGO_URI: Optional[str] = None  # Prefer this; can be populated from MONGODB_URI
    ...
    # CORS
    CORS_ORIGINS: str = (
        "http://localhost:3000,http://localhost:5173,http://localhost:5174,http://localhost:5178,http://localhost:8000,"
